...
//+++ new vibrator driver interface for Android O	
...
//stereo
#define	TAS2560_VIB_PHONE			0	/* Only Phone */
#define	TAS2560_VIB_STATION_ALL		1	/* Station Left and Right */
#define	TAS2560_VIB_STATION_LEFT	2	/* Station Left */
#define	TAS2560_VIB_STATION_RIGHT	3	/* Station Right */
#define	TAS2560_VIB_ALL				4	/* All vibrators */
//end
...
enum channel{
	...
	channel_right = 0x02,
	channel_phone = 0x04,
	channel_both = (channel_left|channel_right),				//two vibrators
	channel_all = (channel_left|channel_right|channel_phone), 	//three vibrators
} ;
...
struct tas2560_priv {
	...
	int mnPPG;
	//for stereo
	unsigned char mnLAddr; //station Left
	unsigned char mnRAddr; //station right
	unsigned char mnPAddr; //phone
	unsigned char mnCurrentAddr; //phone
	enum channel mnCurrentChannel; //cu	int channel_state = pValue->value.integer.value[0];
	int mnLCurrentBook; //station left
	int mnLCurrentPage; //station left
	int mnRCurrentBook; //station right
	int mnRCurrentPage; //station right
	int mnPCurrentBook; //phone
	int mnPCurrentPage; //phone
	int mnSResetGPIO; //station reset pin
	//end
	//station
	unsigned char dongleType;
	bool station_reset_enable;//station reset pin status
	//end
	//+++ new vibrator driver interface for Android O, by mark_guo
	...
	void (*sw_reset)(struct tas2560_priv *pTAS2560);
	...
	bool sec_mi2s_status;//record sec_mi2s status
	bool sec_mi2s_enable;//allow sec_mi2s enabling
	//end
#endif
