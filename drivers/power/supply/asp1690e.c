	...
	char *buf)
{
	...
	ret = asp1690e_read_reg(0x42,&val[4]);
	if (ret < 0)
		return sprintf(buf, "ERR");

	ret = asp1690e_read_reg(0x44,&val[5]);
	if (ret < 0)
		return sprintf(buf, "ERR");

	ret = asp1690e_read_reg(0x45,&val[6]);
	if (ret < 0)
		return sprintf(buf, "ERR");

	ret = asp1690e_read_reg(0x46,&val[7]);
	if (ret < 0)
		return sprintf(buf, "ERR");

	ret = asp1690e_read_reg(0x47,&val[8]);
	if (ret < 0)
		return sprintf(buf, "ERR");

	ret = asp1690e_read_reg(0x48,&val[9]);
	if (ret < 0)
		return sprintf(buf, "ERR");

	return sprintf(buf, "reg30h = 0x%xh\nreg31h = 0x%xh\nreg3Ch = 0x%xh\nreg3Dh = 0x%xh\nreg42h = 0x%xh\nreg44h = 0x%xh\nreg45h = 0x%xh\nreg46h = 0x%xh\nreg47h = 0x%xh\nreg48h = 0x%xh\n",
