...
extern bool rtc_wake_control; /* kernel/msm-4.9/drivers/rtc/qpnp-rtc.c ,default is N */
...
{
	int error = 0;
	if (!rtc_wake_control)	//rtc_wake_control = True, will let kernel layer can't require wakelock
